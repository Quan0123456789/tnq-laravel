...
@section('layout') 
    ...
    <div id="product-head" class="row" >
        <div id="product-img" class="col-lg-6 col-md-6 col-sm-12">
            <img src={{asset('upload/' . $productDetail->image)}} >
        </div>
        <div id="product-details" class="col-lg-6 col-md-6 col-sm-12">
            ...
            <ul>
                ...
                <li><span>Tình trạng:</span>{{ $productDetail->title  }}</li>
                <li><span>Khuyến Mại:</span> {{ $productDetail->discount }} %</li>
                <li id="price">Giá Bán (chưa bao gồm VAT)</li>
                <li id="price-number">{{ $productDetail->price}} </li>
